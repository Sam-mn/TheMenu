...
namespace theMenu
{
    internal class Main
    {
        ...
        private static void getTheThirdWord()
        {
            ...
            var wordsWithoutSpaces = new List<string>();
            ...
            if (wordsWithoutSpaces.ToArray().Length >= 3)
            {
                Console.WriteLine("____________________________________________________________________________");

                Console.WriteLine($"The third word is: {wordsWithoutSpaces[2]}");
            }
            else
            {
        ...
        private static void checkTheAge()
        {
            ...
            for (int i = 0; i < num; i++)
            {
                uint age = ValidationsHelpers.CheckIfValidIntgeer($"Could you write the age of number {i + 1}? ");
